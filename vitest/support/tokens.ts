...
import { contrast, luminance, parseColor, type Rgb } from '../../src/lib/utils/contrast';

/*
 * Формула контрасту живе в `$lib/utils/contrast`, а не тут: її читає ще й
 * лабораторія кольорів у браузері, і дві копії однієї формули означали б, що
 * інструмент каже «пройде», а гейт у CI каже «ні». Ре-експорт — щоб виклики
 * в тестах не мінялися.
 */
export { contrast, luminance, parseColor, type Rgb };
