...
<section class="error-page container" style="padding: var(--page-pad-top) 24px var(--page-pad-bottom); min-height: 80vh; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center;" data-testid="error-page-section">
