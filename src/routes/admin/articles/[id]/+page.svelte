...
<section class="admin-article-edit container" style="padding: 160px 24px;">
	{#if loading}
		<p style="text-align: center;">Завантаження даних статті...</p>
	{:else}
		<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
			<h1 style="font-family: var(--font-heading); color: var(--color-deep-ocean);">Редагування статті</h1>
			<a href="/admin/articles" class="btn btn-outline">Назад до списку</a>
		</div>
		...
		<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem;">
			...
			<form onsubmit={handleSubmit} style="display: flex; flex-direction: column; gap: 1.5rem; background: white; padding: 2rem; border-radius: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
				...
				<div style="display: flex; align-items: center; gap: 1rem;">
					...
					<label for="isPublished">Опубліковано</label>
				</div>

				<button type="submit" disabled={saving} class="btn btn-primary" style="width: 100%; border: none;">
					{saving ? 'Оновлення...' : 'Оновити статтю'}
				</button>
			</form>
