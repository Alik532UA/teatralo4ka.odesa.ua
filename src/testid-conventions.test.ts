...
/**
 * Перевірка конвенцій data-testid за TESTID-AND-NAMING-v9.md § 1.9.1.
 *
 ...
 * (TESTID-AND-NAMING-v9 § 1.2, стратегія B — testid лишаються в продакшні).
 *
 ...
 * відсутній (CODE-QUALITY-v9 § 6.4.1). Публічна частина тримається на нулі.
 *
 * Зворотний експеримент (AI-AGENT-PITFALLS-v9 § 1.1): прибрати `data-testid` у
