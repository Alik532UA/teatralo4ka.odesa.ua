 ...
 * (ACCESSIBILITY-v9 § 2, WCAG 2.1.1, рівень A).
 *
 ...
 * (ACCESSIBILITY-v9 § 10.1: покриття приблизно третина критеріїв). Компілятор
 ...
 *
 * Зворотний експеримент (AI-AGENT-PITFALLS-v9 § 1.1): прибрати `onkeydown` із
 ...
 *
 * Зворотний експеримент (AI-AGENT-PITFALLS-v9 § 1.1): повернути `if (!isHovered)
