...
const FOCUSABLE = [
	...
	// `iframe` фокусований нативно, і без нього Tab у вікні з анкетою Google
	// ходив по двох кнопках шапки, НІКОЛИ не заходячи в саму форму: усе, заради
	// чого вікно відкрили, було недосяжне з клавіатури. Далі Tab уже всередині
	// рамки веде сам браузер — чужий документ нам не належить, і забирати з
	// нього фокус пасткою не можна (вийти звідти можна Escape).
	'iframe',
