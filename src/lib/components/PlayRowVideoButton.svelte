<script lang="ts">
	 ...
	 * сітки рядка, і їхній порядок був зашитий усередині. Тепер порядок і місце
	 * визначає батько (`GraduatePlayRow`): він складає хвіст рядка з плашки й
	 * кнопки в потрібному порядку, а в рядку уривка ставить кнопку саму. Два
	 * незалежних питання — «з ким грав» і «чи є запис» — два компоненти.
	 */
	interface Props {
