...
<style>
	...
	@media (min-width: 860px) {
		.flow-stream {
			 ...
			 *
			 * 1200 мс, а не `--transition-base` (250). Числом ішли крок за кроком:
			 * 250 читалося як стрибок, 420 і 700 — усе ще швидко. Цей стовпець не
			 * повідомлення й не відповідь на дію: він просто відходить, щоб не
			 * заважати читати, і має робити це так, щоб око не смикалося. Крива
			 ...
			 */
			transition: translate 1200ms cubic-bezier(0.4, 0, 0.2, 1);
		}
