...
<style>
	...
	/*
	 * КРАПКИ НЕ СТИСКАЮТЬСЯ Й ПЕРЕНОСЯТЬСЯ.
	 *
	 * Флекс типово дозволяє елементам худнути, і на довгій галереї це ламало їх
	 * до невпізнання: у галереї випускника 29 знімків, тобто 29×9 px плюс 28
	 * проміжків — 485 px у колонку, вужчу за це. Кожна крапка стискалася до
	 * двох пікселів завширшки, лишаючись дев'ять заввишки, і ряд круглих крапок
	 * перетворювався на частокіл рисок. Автор надіслав знімок саме такого ряду.
	 *
	 * Банер задумувався під кілька знімків групи, і доти цього не траплялося;
	 * галерея анкети підключила його до списку на порядок довшого.
	 */
	.banner__dots {
		display: flex;
		flex-wrap: wrap;
	 ...
	 */
	.banner__dot {
		/* Не худне: саме це й робило з крапки риску. */
		flex: none;
		width: 9px;
		height: 9px;
		padding: 0;
