<script lang="ts">
	 ...
	 */
	// eslint-disable-next-line svelte/prefer-svelte-reactivity -- саме нереактивний:
	// це пам'ять, а не стан. Реактивна множина перезапускала б ефект відбору на
	// кожну позначку «показано» й ганяла б перерахунок черги по колу.
