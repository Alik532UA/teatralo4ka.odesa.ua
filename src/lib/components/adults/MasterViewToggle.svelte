...
<style>
	 ...
	 * від переліку вистав, груп, майстрів. Півсили каже «я тут, коли знадобишся»
	 * і не сперечається зі змістом.
	 *
	 * Прозорість несе КОНТЕЙНЕР, а не кнопки: своєї прозорості в них немає, тож
	 * перемножуватися нічому — на відміну від кнопок сцени галактики, де кожна
	 * мусила світлішати окремо.
	 *
