...
<div
	class="admin-card"
	style="padding: 2.5rem; border-radius: 32px; background: var(--bg-card); box-shadow: 0 10px 40px rgba(0,0,0,0.03); border: var(--hairline-width) solid rgba(0,0,0,0.05);"
...
>
	...
	<div
		...
		style="background: var(--bg-surface); padding: 3rem; border-radius: 24px; border: var(--hairline-width) solid rgba(0,0,0,0.05);"
	>
		<article class="prose" style="max-width: 1000px; margin: 0 auto;">
			...
			{:else}
				<!-- Виняток за SECURITY-v9 § 5.3: попередній перегляд того, що редактор
