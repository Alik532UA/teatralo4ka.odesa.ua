...
/**
 * Мінімальний інтервал між перевірками (VERSIONING-v9 § 4.1).
 *
...
export async function checkForUpdates() {
    ...
    // VERSIONING-v9 § 4.2. Запит, який не може вдатися, не варто відправляти:
    ...
    // VERSIONING-v9 § 4.1. Дросель живе В СЕРВІСІ, а не в місці виклику. Зараз
    ...
    try {
        ...
        // warn, а НЕ error (VERSIONING-v9 § 4.3, HIGH; те саме в ERROR-HANDLING-v9
        // і DEBUGGING-v9). Сюди приходить рівно один клас подій — не вдалося
    ...
    // ПОЗА try (VERSIONING-v9 § 4.3): у `try` загортається лише мережевий
