...
/**
 * Ніхто не визначає поле вводу за `tagName` (HOTKEYS-v9 § 2, HK-TEXT-ENTRY-GUARD,
 * CRITICAL).
 *
 ...
 *
 * Зворотний експеримент (AI-AGENT-PITFALLS-v9 § 1.1): повернути порівняння
 ...
 *
 * Ціна така сама, як у будь-якого застарілого числа (AI-AGENT-PITFALLS-v9 § 5.5):
