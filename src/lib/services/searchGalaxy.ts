 ...
 * пошук не знаходить Віктора Фурдуя — він `linked`, «друг школи», і стоїть на
 ...
 *
 * Без цього всі йшли як «випуск»: Віктор Фурдуй, друг школи, який ніколи тут не
 * вчився, підписувався випускником рівно в тому рядку, де людина перевіряє, чи
 * то саме той, кого вона шукає.
 */
