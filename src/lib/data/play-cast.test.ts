 ...
 *
 * Зворотний експеримент (AI-AGENT-PITFALLS-v9 § 1.1): дописати виставу в
...
describe('склад вистав', () => {
  ...
  ${b}`).join('')
	 ...
	 * суворим: у «Уривках з класики» 2013 Алік Запольнов грав і в «Антігоні»,
	 * і в «Незнайомці», і в «Сонетах». Це три різні номери, у кожного своя
	 * роль — а роль живе В РЯДКУ. Злити їх в один рядок означало б утратити
	 * дві з трьох ролей.
	 *
