 ...
 * 2026-09-11: `ui/ThemeLab.svelte` дістав власну стелю 315 (типова для
 *   компонента — 300). Одинадцять рядків — вставка готового блоку теми на
 *   прохання автора («скопіювати кольори можна, а ось знову їх вставити ні»):
 *   кнопка, розбір відповіді й запасне поле на випадок, коли браузер не дав
 *   прочитати буфер.
 *
 *   Виносити це окремим компонентом нема за чим: вікно і так поділене за
 *   швом «поведінка проти полів» (`ThemeLabFields`), а вставка — саме
 *   поведінка вікна, як і копіювання поруч. Третій файл на двадцять рядків
 *   додав би перехід, а не ясність.
 */
const CEILINGS: Record<string, number> = {
	'src/lib/components/ui/ThemeLab.svelte': 315,
