 ...
 *
 * Восьмий кандидат був і зник: 2026-09-07 сюди лягла Анастасія Ніколаєва —
 * автор назвав її серед учасниць поїздки на Art Like Fest 2026, а в реєстрі
 * майстрів уже стояла колишня викладачка вокалу з тим самим іменем. Певності не
 * було, тож замість зв'язку тут стояв запис. 2026-09-08 автор відповів: людина
 * ОДНА, і вона викладачка. Запис учениці прибрано, а на фестивалі вона
 * лишилася — у «викладачах, що їздили».
 *
 * Обережність себе виправдала: помилковий запис коштував рядка в реєстрі, а
 * помилковий зв'язок склеїв би дві сторінки в одну людину.
 *
