 ...
 * (SVELTE-UI-v9 § 4, SVELTE-CORE-v9 § 6).
 *
...
/**
 * SVELTE-UI-v9 § 1 — API Svelte 4 у проєкті на рунах.
 *
 ...
 * (CODE-QUALITY-v9 § 6.4.1). Правила ESLint на це немає: `svelte/no-deprecated-slot`
...
/**
 * SVELTE-UI-v9 § 4 — кожен `svelte-ignore` має поруч записану причину.
 *
 ...
 *
 * Зворотний експеримент (AI-AGENT-PITFALLS-v9 § 1.1): прибрати коментар-причину
...
/**
 * SVELTE-CORE-v9 § 3.3 і § 6 — контекст лише через типізований аксесор.
 *
