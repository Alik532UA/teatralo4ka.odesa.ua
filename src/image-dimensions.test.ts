 ...
 * відсутній (CODE-QUALITY-v9 § 6.4.1).
 *
 ...
 *
 * Зворотний експеримент (AI-AGENT-PITFALLS-v9 § 1.1): прибрати `{...imageSize`
...
describe('розміри зображень (PERFORMANCE-v9 § 3.2)', () => {
