...
- **Порядок сортування в категоріях:**
  - `administration`: фіксована послідовність (1. Олена Ткач, 2. Оксана Панченко, 3. Світлана Риськіна, 4. Віра Коваль, 5. Лілія Величко, 6. Наталія Шалашна, 7. Любов Франковська, 8. Тетяна Коренчук).
  - `pedagogues` та `history`: сортування за кількістю випускників (`graduatesCount`) за спаданням.
