/**
 * Перевірка правил доступу Firestore над емулятором (CLOUD-DATABASE-v9, CDB-RULES-GATE).
 *
 ...
 * (AI-AGENT-PITFALLS-v9 § 1.3). Тут навпаки: команда сама піднімає емулятор і
 * повертає код виходу.
 *
